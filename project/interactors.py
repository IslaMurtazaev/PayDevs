...
class GetTaskInteractor(Interactor):
    ...
    def set_params(self, user_id, project_id, task_id, title, **kwargs):
        self.user_id = user_id
        self.project_id = project_id
...
class UpdateTaskInteractor(Interactor):
    ...
    def set_params(self, user_id, project_id, task_id, new_attrs, **kwargs):
        self.user_id = user_id
        self.project_id = project_id
        self.task_id = task_id
...
class GetAllTasksInteractor(Interactor):
    ...
    def set_params(self, user_id, project_id, **kwargs):
        self.user_id = user_id
        self.project_id = project_id
        return self
