...
describe("<TaskItem />", () =>{
    ...
    it("renders mount <TaskItem /> h4 count", () =>{
        ...
        const task = {id: 1, title: "Task number 1", description: "Test a ", price: 500, completed: true}
        ...
        expect(component.find('.taskCompleted').text()).toBe(task.completed ? ">Completed": ">Uncompleted");
    ...
    it("renders mount <TaskItem /> click onDelete", () =>{
        ...
        const options = new ReactRouterEnzymeContext();
        const task = {id: 1, title: "Task number 1", description: "Test a ", price: 500}
        const component = mount(<TaskItem task={task} onDelete={onDeleteSpy}/>, options.get());
