...
urlpatterns = [
    ...
    path('project/<int:project_id>/month_payment/<int:month_payment_id>/', ViewWrapper.as_view(
        view_factory=get_month_payment_factory),
         name='get_month_payment'),

    path('project/<int:project_id>/month_payment/<int:month_payment_id>/update/',
         csrf_exempt(ViewWrapper.as_view(view_factory=update_month_payment_factory)),
         name='update_month_payment'),

    path('project/<int:project_id>/month_payment/<int:month_payment_id>/delete/',
         csrf_exempt(ViewWrapper.as_view(view_factory=delete_month_payment_factory)),
         name='delete_month_payment'),

    path('project/<int:project_id>/month_payment/all/', ViewWrapper.as_view(view_factory=get_all_month_payments_factory),
         name='get_all_month_payments'),



    path('project/<int:project_id>/month_payment/<int:month_payment_id>/worked_day/create/',
         csrf_exempt(ViewWrapper.as_view(view_factory=create_worked_day_factory)),
         name='create_worked_day'),

    path('project/<int:project_id>/month_payment/<int:month_payment_id>/worked_day/<int:worked_day_id>/',
         ViewWrapper.as_view(view_factory=get_worked_day_factory),
         name='get_worked_day'),

    path('project/<int:project_id>/month_payment/<int:month_payment_id>/worked_day/<int:worked_day_id>/update/',
         csrf_exempt(ViewWrapper.as_view(view_factory=update_worked_day_factory)),
         name='update_worked_day'),

    path('project/<int:project_id>/month_payment/<int:month_payment_id>/worked_day/<int:worked_day_id>/delete/',
         csrf_exempt(ViewWrapper.as_view(view_factory=delete_worked_day_factory)),
         name='delete_worked_day'),

    path('project/<int:project_id>/month_payment/<int:month_payment_id>/worked_day/all/',
         ViewWrapper.as_view(view_factory=get_all_worked_days_factory),
         name='get_all_worked_days'),
