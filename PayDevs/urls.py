...
from project.factories import get_project_factory, create_project_factory, get_all_projects_factory, \
                                get_total_factory, create_task_factory, get_all_tasks_factory
...
urlpatterns = [
    ...
    path('project/total/<slug:title>', ViewWrapper.as_view(view_factory=get_total_factory), name='get_total')
]
